...
- runnable standard-library Python package and CLI;
- synthetic sanitized normalized-conversation and authority fixtures;
- eight automated tests;
- fail-closed source-reference validation;
- Project Spine, Authority Ledger, review queue, Continuation Brief, and Source Trace outputs;
